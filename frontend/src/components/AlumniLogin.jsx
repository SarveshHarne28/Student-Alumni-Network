...
export default function AlumniLogin({ setToken }) {
          ...
          <div style={styles.leftPanel}>
            <div style={styles.brandSection}>
              ...
              <p style={styles.brandSubtitle}>
                Sign in to share opportunities and mentor the next generation
              </p>
            </div>
            ...
            <div style={styles.benefitsSection}>
              <div style={styles.benefitItem}>
                ...
                <div>
                  <h3 style={styles.benefitTitle}>Post Opportunities</h3>
                  <p style={styles.benefitText}>Share job openings and internships with students</p>
                </div>
              </div>
              ...
              <div style={styles.benefitItem}>
                <div style={styles.benefitIcon}>🤝</div>
                <div>
                  <h3 style={styles.benefitTitle}>Mentorship</h3>
                  <p style={styles.benefitText}>Guide and inspire future professionals</p>
                </div>
              </div>
              ...
              <div style={styles.benefitItem}>
                <div style={styles.benefitIcon}>🌐</div>
                <div>
                  <h3 style={styles.benefitTitle}>Network Growth</h3>
                  <p style={styles.benefitText}>Expand your professional network within JNEC</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={styles.rightPanel}>
            <div style={styles.formContainer}>
              <div style={styles.formHeader}>
                <h2 style={styles.formTitle}>🎓 Alumni Login</h2>
